...
const GenreInto = ({ }: IProps) => {
    ...
    async function getGamesData() {
        setLoading(true);
        const allGames = await fetch(`https://api.rawg.io/api/games?key=${apiKey}&page=${currentPage}&genres=${slug}`, { mode: "cors" })
